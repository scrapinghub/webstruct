...
from webstruct.token import Token, HtmlToken
from webstruct.text_tokenizers import tokenize as word_tokenize
    ...
    def tokenize_single(self, text):
        ...
        * a list of associated tags.
        ...
        Example:
            ...
            >>> from webstruct import AnnotatedTextLoader, TextTokenizer
            >>> loader = AnnotatedTextLoader(known_entities={'PER'})
